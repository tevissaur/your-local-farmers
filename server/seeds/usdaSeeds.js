...
class csaSeeder {
	static file = xlsx.parse(
		fs.readFileSync(path.join(__dirname, "./csa_2022-66195453.xlsx"))
	);
	static farms = [];
	static allProducts = {};
	seed() {
...
let file = xlsx.parse(
	fs.readFileSync(
		"C:/Users/tevis/code/bootcamp/your-local-farmers/server/seeds/csa_2022-66195453.xlsx"
	)
);
